...
import express from "express";
import { createTemplate, getAllTemplates, getTemplateById, previewShowTemplate,previewTemplate, getFavoriteTemplates, updateTemplate, permanentlyDeleteTemplate, duplicateTemplate, getRecentlyUsedTemplates, getPastCampaignTemplates, toggleFavoriteTemplate, deleteTemplate, restoreTemplateById } from "../controllers/templateController";
import { authenticateToken } from "../middleware/authMiddleware";
